...
import { Calendar, Zap, CheckCircle, AlertTriangle, RefreshCw } from 'lucide-react';
...
export const Topbar: React.FC<TopbarProps> = ({ setActiveTab }) => {
  ...
  return (
    <header className="h-16 bg-slate-900/90 backdrop-blur border-b border-slate-800 px-6 flex items-center justify-between shrink-0 sticky top-0 z-20">
      {/* Event Selector */}
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 bg-slate-800/80 border border-slate-700/60 rounded-xl px-3 py-1.5 text-slate-300">
